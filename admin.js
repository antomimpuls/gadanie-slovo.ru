(() => {
  ...
  const injectStyles = () => {
    ...
    style.textContent = `
      .admin-panel{position:fixed;bottom:24px;left:24px;width:320px;max-width:92vw;background:rgba(45,45,26,0.94);color:#f5f5e8;border:1px solid rgba(234,179,8,0.4);border-radius:16px;padding:18px;box-shadow:0 18px 38px rgba(0,0,0,0.4);z-index:9999;font-family:'Inter','Segoe UI',sans-serif;backdrop-filter:blur(12px);}
      ...
      .admin-panel__input{flex:1 1 140px;padding:10px 12px;border-radius:10px;border:1px solid rgba(234,179,8,0.5);background:rgba(20,20,12,0.85);color:#f5f5e8;font-size:14px;}
      .admin-panel__btn{padding:10px 14px;border-radius:10px;border:none;background:linear-gradient(135deg,#eab308,#ca8a04);color:#fefce8;font-weight:600;cursor:pointer;transition:transform .15s ease, box-shadow .15s ease;}
      .admin-panel__btn:hover{transform:translateY(-1px);box-shadow:0 12px 20px rgba(234,179,8,0.35);}
      .admin-panel__btn--ghost{background:rgba(234,179,8,0.16);color:#f5f5e8;}
      .admin-panel__btn--ghost:hover{box-shadow:0 12px 20px rgba(234,179,8,0.25);}
      ...
      .admin-wa-target{outline:1px dashed rgba(234,179,8,0.6);outline-offset:4px;position:relative;}
      .admin-wa-target::after{content:'WA';position:absolute;top:-10px;right:-10px;font-size:11px;background:rgba(234,179,8,0.85);color:#fefce8;padding:2px 6px;border-radius:999px;}
